...
and contact — built to read well in seconds to any visitor, technical or not.
...
- Contact section as branded action buttons: Gmail compose, LinkedIn, GitHub
...
- `script.js` — theme toggle, scroll reveal, mobile nav (all via `addEventListener`)
